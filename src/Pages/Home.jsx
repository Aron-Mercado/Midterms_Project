        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-slate-300 flex items-center gap-3">
            ...
            <p className="text-lg text-slate-400 leading-relaxed max-w-xl">
              A student prepared to explore a wide range of knowledge in coding, 
              with the goal of becoming an industry-ready and technologically proficient professional. 
            </p>
            ...
            <div className="flex items-center space-x-6 pt-8 border-t border-slate-800/50" >
